...
this.fields =new LinkedHashMap<>();
    ...
    public String addPlayer(String fieldName, String playerType, String playerName, String nationality, int strength) {
        ...
        if (playerType.equals("Men")){
            player =new Men(fieldName,nationality,strength);
        } else if (playerType.equals("Women")) {
            player =new Women(fieldName,nationality,strength);
        } else {
...
int size =fields.get(fieldName).getPlayers().size();
    ...
    public String calculateStrength(String fieldName) {
       int strength = fields.get(fieldName).getPlayers()
    ...
    public String getStatistics() {
      ...
      fields.values().stream().forEach(field -> sb.append(field.getInfo()).append(System.lineSeparator()));
